...
export default function About () {
  return (
    <div className="flex flex-col w-full mobile-about">          
      <section className="mobile-about ">
        <h2 id="main" className="text-xl p-5 mb-6 text-green-400 hover:text-white italic bg-slate-600
        mobile-welcome">Olá, Seja bem vindo(a) !</h2>
        <div className="flex flex-col text-center gap-6 items-center justify-center mobile-about">          
          <h3 id="about" className="text-2xl font-semibold text-emerald-500 mx-10">Sobre mim</h3> 
          <div className="flex items-center justify-center mobile-about">
            <p className="mx-10 mb-20 text-white w-3/6 text-start description-mobile">Desenvolvedor Front-end, apaixonado pela programação e desenvolvimento. Venho em constante evolução, desenvolvendo exercícios e projetos referentes aos aprendizados que obtenho. Atualmente estou cursando <strong>JavaScript MasterClass na AgileCode</strong> e <strong>JavaScript Full-Stack na OneBitCode</strong>, buscando sempre aprender novas tecnologias e me aprimorar profissonalmente. </p>
            <ul className="mx-10 mb-20 text-white flex flex-col justify-center border-solid border-2 border-emerald-500 text-start p-3 gap-2 ul-mobile">
        ...
        <div className="flex flex-col text-center gap-6 mobile-tools">
          <h3 id="tools" className="text-2xl font-semibold text-emerald-500 mx-10">Linguagens</h3>
          <div className="flex justify-center gap-12 text-center mb-20 tools-mobile">
